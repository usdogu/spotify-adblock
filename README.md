...
```bash
$ git clone https://github.com/usdogu/spotify-adblock.git
$ cd spotify-adblock
$ make
```
...
#### Flatpak
```bash
mkdir -p ~/.spotify-adblock && cp zig-out/lib/libspotify-adblock.so ~/.spotify-adblock/spotify-adblock.so
...
# Thanks
* To [abba23](https://github.com/abba23) for the original project
